  ...
  const simulationRuns: SimulationRun[] = [
    {
      ...
      stats: { eventsPerSecond: 182, p95LatencyMs: 41 },
    },
    {
      runId: 'SIM-000002',
      seed: 1337,
    ...
    },
    {
      ...
      stats: { duplicatesInjected: 120, duplicatesRejected: 120 },
    },
  ];
  ...
  const scenarios: Scenario[] = [
    {
      ...
      expectedOutcome: 'Readiness climbs from AT_RISK to READY and the case leaves AWAITING_EVIDENCE without a replay.',
      chaosTypes: ['DELAYED_EVENT', 'OUT_OF_ORDER_EVENT'],
      estimatedSeconds: 90,
    },
    {
      key: 'duplicate-storm',
      ...
      expectedOutcome: 'Duplicate counters rise, state does not move, and the readiness score is unchanged.',
      chaosTypes: ['DUPLICATE_EVENT'],
      estimatedSeconds: 60,
    },
    {
      key: 'evidence-tamper',
      ...
      expectedOutcome: 'Integrity verification fails, the artifact is INVALIDATED, and a CRITICAL gap appears.',
      chaosTypes: ['CORRUPT_EVIDENCE_HASH', 'DELETE_EVIDENCE'],
      estimatedSeconds: 45,
    },
    {
      key: 'worker-outage',
      ...
      expectedOutcome: 'Consumer lag spikes then drains; no event is lost and no score is recomputed twice.',
      chaosTypes: ['KILL_WORKER', 'RESTART_CONSUMER'],
